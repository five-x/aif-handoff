...
function makeEnv(overrides: Record<string, unknown> = {}) {
  return {
    ...
    AIF_RETRY_CONTEXT_ACTIVITY_MAX_CHARS: 32_000,
    AIF_RETRY_CONTEXT_ACTIVITY_MAX_LINES: 500,
    AIF_RETRY_CONTEXT_ACTIVITY_MAX_ESTIMATED_TOKENS: 8_000,
    AIF_RETRY_CONTEXT_RUNTIME_USAGE_MAX_TOKENS: 24_000,
