...
- Do not promote line count, direct import count, monolithic-file shape, coupling-smell wording, orphaned-module guesses, or unclear-ownership/documentation observations into trusted findings unless you prove a concrete broken behavior, unsafe boundary, or full-repository unused-code result with exact ledger-backed evidence. Otherwise discard the observation or mark the report source_inconclusive.
