...
- Do not promote line count, single-file bottleneck, single point of architectural failure, direct import count, direct import dependency, one-directional import coupling, data-model imports, render-function imports, "schema change requires import update", "adding UI output requires modifying a hub", handler-registry extraction, interface-contract extraction, absolute-vs-relative import style, central-hub/single-point-of-change wording, ownership-gap/documented-owner claims, README/AGENTS ownership-boundary gaps, monolithic-file shape, coupling-smell wording, orphaned-module guesses, missing/implicit __all__/module-docstring observations, optional-dependency/no-runtime-guard guesses, direct-read-not-completed limitations, budget-constraint limitations, or unclear-ownership/documentation observations into trusted findings unless you prove a concrete broken behavior, unsafe boundary, or full-repository unused-code result with exact ledger-backed evidence. Otherwise discard the observation or mark the report source_inconclusive.
