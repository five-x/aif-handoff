...
- Do not promote line count, direct import count, direct import dependency, one-directional import coupling, absolute-vs-relative import style, central-hub/single-point-of-change wording, ownership-gap/documented-owner claims, monolithic-file shape, coupling-smell wording, orphaned-module guesses, missing __all__/module-docstring observations, or unclear-ownership/documentation observations into trusted findings unless you prove a concrete broken behavior, unsafe boundary, or full-repository unused-code result with exact ledger-backed evidence. Otherwise discard the observation or mark the report source_inconclusive.
