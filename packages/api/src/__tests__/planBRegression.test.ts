...
function validAuditRoadmapContent(): string {
  ...
  return [
    ...
    "  - Expected report artifact: audit/2026-05-13-api-entrypoint-audit.md",
    "  - Allowed write paths: audit/2026-05-13-api-entrypoint-audit.md",
    ...
    "  - Expected report artifact: audit/2026-05-13-summary.md",
    "  - Allowed write paths: audit/2026-05-13-summary.md",
