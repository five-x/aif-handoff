...
memory_id: task::aif-handoff::work::work-20260513-define-workflow-contract-pack-interface::delta
project_id: project::aif-handoff
repo_name: aif-handoff
lane: work
task_id: work-20260513-define-workflow-contract-pack-interface
source_path: docs/rdpi/work/work-20260513-define-workflow-contract-pack-interface
stability: validated
...
- task-delta
  source_refs:
- docs/rdpi/work/work-20260513-define-workflow-contract-pack-interface/research.md
...
Curated delta for task work-20260513-define-workflow-contract-pack-interface.
