...
memory_id: task::aif-handoff::work::work-20260513-add-task-hierarchy-schema-api-contract::hypotheses
...
Local-only hypotheses collected during task work-20260513-add-task-hierarchy-schema-api-contract.
