...
memory_id: task::aif-handoff::work::work-20260508-prevent-hallucinated-zero-delta-verification::project-capsule
...
Current capsule for project aif-handoff, refreshed by task work-20260508-prevent-hallucinated-zero-delta-verification.
